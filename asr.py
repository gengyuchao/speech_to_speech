...
class TransformersASR:
    def __init__(self, model_path="/home/gyc/Project/clean_code/speech_to_speech/resources/Belle-whisper-large-v3-turbo-zh", 
                 device=None):
        """
        初始化ASR模型
...
# 2. 强制使用CPU
# asr = TransformersASR(device="cpu")

# 3. 强制使用GPU
# asr = TransformersASR(device="cuda")

# 4. 使用特定GPU
# asr = TransformersASR(device="cuda:1")